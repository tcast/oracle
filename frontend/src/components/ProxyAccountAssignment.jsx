    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
        <div className="min-w-0">
          ...
          <p className="page-subtitle">Assign multiple proxies to each social account for automatic rotation</p>
        </div>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-sm text-blue-800 flex items-start gap-3">
        ...
        <span>Assign multiple proxies to each social account for automatic rotation. Residential proxies are recommended for better success rates.</span>
      </div>
