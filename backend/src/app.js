...
const linkedinFollowsRouter = require('./routes/linkedinFollows');
const redditFollowsRouter = require('./routes/redditFollows');
...
app.use('/api/linkedin-follows', linkedinFollowsRouter);
app.use('/api/reddit-follows', redditFollowsRouter);
