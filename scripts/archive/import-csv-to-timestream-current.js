...
// Function to convert CSV row to Timestream record with current timestamp
function convertRowToTimestreamRecord(row) {
    try {
        ...
        // Use current time for the Timestream timestamp
...
if (args.includes('--test')) {
    ...
    console.log('  node import-csv-to-timestream-current.js --test    # Run with 100 records only');
    console.log('  node import-csv-to-timestream-current.js --full    # Run full import');
} 